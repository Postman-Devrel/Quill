...
import {
  ...
  readConfluenceTool,
  readConfluenceCommentsTool,
  updateConfluencePageTool,
  replyConfluenceCommentTool,
...
const agent = new Agent({
  ...
  tools: {
    ...
    read_confluence_comments: readConfluenceCommentsTool,
    update_confluence_page: updateConfluencePageTool,
    reply_confluence_comment: replyConfluenceCommentTool,
